      ...
      {isOpen && (
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
          >
            <span className="font-mono text-[10px] tracking-[0.16em] opacity-0 group-hover:opacity-100 transition-opacity">close (esc)</span>
          ...
          <div className="relative z-10 w-full max-w-5xl px-8 md:px-12 flex flex-col md:flex-row gap-10 md:gap-16 items-center">
            ...
            <div className="flex-shrink-0 flex flex-col items-center">
              ...
              >
                <div className="font-mono text-[9px] text-white/40 mb-2 tracking-[0.24em] uppercase">{isPlaying ? 'playing' : 'paused'}</div>
            ...
            <motion.div className="flex-1 flex flex-col justify-center" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <div className="space-y-6 relative">
                ...
                <div className="relative pl-6">
                  ...
                  <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">album</h3>
                ...
                <div className="relative pl-6">
                  ...
                  <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">first played</h3>
                ...
                <div className="relative pl-6">
                  ...
                  <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">energy / bpm</h3>
                ...
                <div className="relative pl-6">
                  ...
                  <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">mood</h3>
                ...
                <div className="relative pl-6 pt-4 border-t border-white/5">
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">most played</h3>
                      <p className="font-mono tracking-wide text-[13px] text-white/80">{stats?.mostPlayed ?? '—'}</p>
                    </div>
                    <div>
                      <h3 className="font-mono text-[10px] tracking-[0.16em] text-white/35 mb-1 uppercase">plays</h3>
              ...
              <div className="mt-8 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <span className="font-sans tracking-wide text-[12px] font-semibold">{isPlaying ? 'pause' : 'play'}</span>
                  </button>
                  <button
                ...
                <div className="flex items-center gap-2">
                  <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-full border border-white/10 hover:bg-white/5 text-white/45 hover:text-white/80 transition-all">
                    ...
                    <span className="font-mono text-[10px] tracking-wide">vocal</span>
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-full border border-white/10 hover:border-[#F0B56A]/40 hover:bg-[#F0B56A]/5 hover:text-[#F0B56A] text-white/45 transition-all">
                    ...
                    <span className="font-mono text-[10px] tracking-wide">save</span>
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-full border border-white/10 hover:bg-white/5 text-white/45 hover:text-white/80 transition-all">
                    <Plus className="w-3 h-3" />
                    <span className="font-mono text-[10px] tracking-wide">queue</span>
                  </button>
                </div>
              </div>
            </motion.div>
